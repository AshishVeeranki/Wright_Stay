...
<body>
	...
	<table align="center" border="2" width="1700">
	...
	<%
		...
		ResultSet rs = statement.executeQuery(
				"SELECT houseid, b.userid, communityName, mailingAddress, city, usstate, zipcode, rent, distance, vacancies,  postedby, posteddate, phone, email, lastName FROM houses a, users b WHERE a.userID = b.userID");
	...
	<table align="center" border="1" width="1700" class="table-hover">

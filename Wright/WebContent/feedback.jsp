                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                            	<input type="button" value="Report Feedback" 
onclick="window.location='reportfeedback.jsp'" class="btn btn-dark btn-lg"  />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                	...
                                	<input type="button" value="View All Feedbacks" 
onclick="window.location='viewuserfeedback.jsp'" class="btn btn-dark btn-lg"  />
                            </div>
                        </div>

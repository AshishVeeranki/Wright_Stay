                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="Search.jsp">
                                    <img class="img-portfolio img-responsive" height="400" width="400" src="images/search.jpg">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="PostDetails.jsp">
                                    <img class="img-portfolio img-responsive" height="400" width="400"  src="images/post.jpg">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="feedback.jsp">
                                    <img class="img-portfolio img-responsive" height="400" width="400" src="images/feedback.jpg">
                                </a>
                            </div>
                        </div>
                    </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1 text-center">
				...
				<a href="EditUserDetails.jsp"><font color="#33cc33">&#9679;</font>Edit<font color="#ffffff">&#9679;</font></a>
